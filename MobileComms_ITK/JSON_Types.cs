...
{
    public class WaitTaskCancelQuery_POST
    {
        public string namekey { get; set; }
        public string robot { get; set; }
    }  
    public class SubscriptionConfig_PUT
    {
        public string namekey { get; set; }
    ...
    public class JobRequest_POST
    {
        ...
        public JobRequestDetail_POST[] details { get; set; } = new JobRequestDetail_POST[2] { new JobRequestDetail_POST(), new JobRequestDetail_POST() };
    }
    public class JobRequestDetail_POST
    {
        public string pickupGoal { get; set; }
        public int priority { get; set; }
        public string dropoffGoal { get; set; }
    ...
    //public class WaitTaskState_GET
    //{
    //    public string namekey { get; set; }
